...
export function ArtRecord() {
  return (
    <section className="container-aa pb-20 pt-16 lg:pb-[100px] lg:pt-[140px]">
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        ...
        <div className="reveal">
          ...
          <p className="mt-6 max-w-[440px] font-display text-[19px] leading-[24px] lg:mt-[60px] lg:text-lead">
          ...
          <p className="mt-6 max-w-[438px] text-[16px] leading-5 text-foreground/60 lg:mt-[60px] lg:text-body">
          ...
          <dl className="mt-10 max-w-[440px] lg:mt-[60px]">
            {RECORD_SPECS.map((spec) => (
              ...
              >
                <dt className="shrink-0 text-[14px] font-semibold uppercase leading-[14px] text-foreground/60">
                  {spec.label}
                </dt>
