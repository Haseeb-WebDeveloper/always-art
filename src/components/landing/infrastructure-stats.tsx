...
export function InfrastructureStats() {
  return (
    <section className="container-wide pb-10 pt-14 lg:pb-10 lg:pt-24">
      <div
      ...
      <p className="reveal mx-auto mt-8 max-w-[440px] text-center text-[16px] leading-5 text-foreground/60 lg:mt-[60px] lg:text-body">
      ...
      <dl className="reveal grid grid-cols-1 gap-x-10 gap-y-12 pb-6 pt-16 sm:grid-cols-2 lg:grid-cols-4 lg:pb-10 lg:pt-[100px]">
        {STATS.map((stat) => (
          <div key={stat.value}>
            ...
            <dd className="mt-6 text-[16px] leading-5 text-foreground/60 lg:mt-[60px] lg:text-body">
              {stat.description}
            </dd>
          </div>
        ))}
